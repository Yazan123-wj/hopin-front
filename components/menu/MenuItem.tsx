    ...
    <article className="grid items-stretch md:grid-cols-2">
      ...
      >
        {item.image ? (
          ...
          <div
            className="flex h-full min-h-[18rem] w-full flex-col items-center justify-center gap-3 bg-foreground/[0.06] text-muted md:min-h-[58vh]"
            aria-hidden="true"
          >
      ...
      <div className="flex items-start gap-4 md:gap-5">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-baseline gap-4">
            <h3 className="min-w-0 break-words font-heading text-[18px] tracking-tight md:text-[22px]">
              {item.name}
            </h3>
            <span
          ...
          {item.description ? (
            <p className="mt-2 max-w-2xl break-words text-[14px] leading-6 text-muted md:text-[15px]">
              {item.description}
            </p>
          ) : null}
