  ...
  return (
    <form onSubmit={onSubmit} className="max-w-[28rem]" noValidate>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="mt-10 inline-flex items-center rounded-[6px] bg-secondary px-6 py-3.5 text-[12px] tracking-[0.16em] uppercase text-background transition-colors duration-300 hover:bg-secondary/90 disabled:opacity-60"
      >
