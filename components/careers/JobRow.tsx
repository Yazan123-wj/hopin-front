        ...
        <div className="grid max-w-3xl gap-8 pb-12 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <button
              ...
              className="group inline-flex items-center gap-3 rounded-[6px] bg-secondary px-6 py-3.5 text-[12px] tracking-[0.16em] uppercase text-background transition-colors duration-300 hover:bg-secondary/90"
            >
              Apply now
